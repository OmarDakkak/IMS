	                ...
	                <div class="panel-body">
	                    ...
	                    <form class="form-inline">
	                        ...
	                        <input type="text" name="nom_recherche" id="nom_recherche" value="<?php echo $nom_recherche ?>"
	                            ...
	                            onclick="getElementById('nom_recherche').value=''" />
	            ...
	            <table class="table table-striped">
	                ...
	                <tbody>
	                    ...
	                    <tr class="<?php echo $id_etudiant ?>" style='display:none'>
	                        <th colspan="12" style="text-align:center"> Stage de première année - Découverte du milieu du
	                            travail </th>
	                    </tr>
	                    <tr class="<?php echo $id_etudiant ?>" style='display:none'>
	        ...
	        function afficherStages(stage1, stage2, stage3, id_etudiant) {
	            ...
	            if (stage3) {
	                if (contents[4].style.display ==
	                    'none') { //si le bouton appuie on affiche la section, on tient compte des indicateurs de stage
